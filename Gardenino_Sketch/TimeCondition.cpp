...
TimeCondition::TimeCondition(Clock* globalClock, Range<DateTime> timeRange)
	...
	, TimeRange(DateTime(2000, 1, 1, timeRange.Start.hour(), timeRange.Start.minute(), timeRange.Start.second()),
		  DateTime(2000, 1, 1, timeRange.End.hour(), timeRange.End.minute(), timeRange.End.second()))
{
}
